 ...
 * Constructor.
 */
LIB_API Shader::Shader(const std::string& m_name) : Object(m_name),type(TYPE_UNDEFINED),
glId(0)
{}
...
void LIB_API Shader::setInt(int param, int value)
{
	glUniform1i(param, value);
}

void LIB_API Shader::setVec3(int param, const glm::vec3& vect)
{
	glUniform3fv(param, 1, glm::value_ptr(vect));
}

void LIB_API Shader::setVec4(int param, const glm::vec4& vect)
{
 ...
 */
void LIB_API Shader::render(const glm::mat4&, void* data)
{
